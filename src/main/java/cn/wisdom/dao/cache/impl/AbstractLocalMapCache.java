 ...
 * May 27, 2015
 */
package cn.wisdom.dao.cache.impl;
...
import cn.wisdom.common.model.LRUMap;
import cn.wisdom.common.utils.CollectionUtils;
import cn.wisdom.dao.cache.LocalCacheManager;
import cn.wisdom.dao.cache.MapCache;
...
public abstract class AbstractLocalMapCache<K, V> implements MapCache<K, V>
{
    ...
    /* (non-Javadoc)
     * @see cn.wisdom.dao.cache.Cache#preLoad()
     */
    @Override
    public void preLoad()
    {
